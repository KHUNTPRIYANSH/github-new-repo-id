...
routeruser.get("api/getuser/:keyword",async(req,res)=>{
...
routeruser.get("/counteNumber/:danceName",async(req,res)=>{
    const {danceName}=req.params;
    let danceNumber = registerdata.find().count();
    console.log(danceNumber);
})
...
routeruser.get("/clerk/:dancename",async(req,res)=>{
    const danceName = req.params;
    try{
